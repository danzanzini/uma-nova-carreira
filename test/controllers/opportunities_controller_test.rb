...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { city_id: @opportunity.city_id, description: @opportunity.description, how_to: @opportunity.how_to, title: @opportunity.title }
    end
  ...
  test "should update opportunity" do
    patch :update, id: @opportunity, opportunity: { city_id: @opportunity.city_id, description: @opportunity.description, how_to: @opportunity.how_to, title: @opportunity.title }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
